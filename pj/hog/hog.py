...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # for _ in range(0,num_rolls,1):
    #     result=dice()
    #     if result==1:
    #         appearone=True
    #     total+=result 
    
    # if appearone is True:
    #     return 1
    # else:
    #     return total
    ...
    for i in all_dices:
        if i == 1:
            sowsad=True
    return 1 if sowsad else sum(all_dices)
    # END PROBLEM 1
...
def picky_piggy(score):
    ...
    "*** YOUR CODE HERE ***"
    def getdigit(n,i):
        """get ith digit from number n in maxrange right to left
        >>> getdigit(12345,3)
        3
        """
        max_range=6
        return n//pow(10,max_range-i)%10
    score%=6
    seven=142857
    return 7 if score==0 else getdigit(seven,score)
    # END PROBLEM 2
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for i in range(1,11,1):
        ...
        result=averaged_func(i,dice)
        if result>highest_score:
            lowest_dicenum=i
            highest_score=result
    return lowest_dicenum
    # END PROBLEM 9
...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    if picky_piggy(opponent_score)>=cutoff or score+picky_piggy(opponent_score)==opponent_score:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
